                                    ...
                                    <table class="min-w-full text-left text-sm font-light" id="Table1">
                                        ...
                                        <tr>
                                            <td colspan="14" style="text-align:center;">
                                                <input class="text-black bg-gray-300 mt-2 mb-3 border border-black hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded" type="button" value="Get Selected" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
